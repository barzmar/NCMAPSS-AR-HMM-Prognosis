rng(1);
p = 3;
PriorMdl = bayeslm(p,'ModelType', 'Conjugate' , 'Intercept', false ,'VarNames', [ppCruiseData(1).flights(1).cruises(1).Name(5:7,1)]);
